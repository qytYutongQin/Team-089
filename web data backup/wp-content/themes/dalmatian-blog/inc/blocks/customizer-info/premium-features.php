...
add_action( 'customize_register', 'dalmatian_blog_customizer_premium_features' );

function dalmatian_blog_customizer_premium_features( $wp_customize ) {
    ...
    $premium_features = '<div class="premium-info"><h2>' . esc_html__( 'Premium Version', 'dalmatian-blog' ) . ': </h2>
	...
	<a class="button button-primary" href="' . esc_url( 'https://graphthemes.com/dalmatian-blog/' ) . '" target="_blank">' . esc_html__( 'Upgrade to Pro', 'dalmatian-blog' ) . '</a></div>';

	$wp_customize->add_control( new Dalmatian_Blog_Custom_Text( $wp_customize ,'premium_features',array(
