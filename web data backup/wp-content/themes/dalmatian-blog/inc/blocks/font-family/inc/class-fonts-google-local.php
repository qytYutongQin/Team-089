...
final class Dalmatian_Blog_Google_Local {
	 ...
	 * @return Dalmatian_Blog_Google_Local
	 */
	...
	public function get_root_path() {
		...
		// Return the path.
		return apply_filters( 'dalmatian_blog_googlefonts_root_path', $path );
	}
	...
	public function get_root_url() {
		...
		return apply_filters( 'dalmatian_blog_googlefonts_root_url', untrailingslashit( esc_url_raw( $url ) ) . '/webfonts' );
	}
	...
	private function get_fonts() {
        dalmatian_blog_get_google_fonts();
	}
