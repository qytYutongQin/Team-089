...
add_action( 'customize_register', 'dalmatian_blog_register_font_customization_section' );
function dalmatian_blog_register_font_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'dalmatian_blog_font_customization_section', array(
	    'title'	=> esc_html__( 'Font Options', 'dalmatian-blog' ),
	    'priority'	=> 20
	) );
