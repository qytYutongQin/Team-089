...
add_action( 'customize_register', 'dalmatian_blog_post_detail_comment' );
function dalmatian_blog_post_detail_comment( $wp_customize ) {

	$wp_customize->add_setting( 'post_detail_hide_show_comment', array(
        'sanitize_callback'     =>  'dalmatian_blog_sanitize_checkbox',
        'default'               =>  dalmatian_blog_get_default_post_detail_comment()
    ) );
