...
add_action( 'customize_register', 'dalmatian_blog_color_section' );
function dalmatian_blog_color_section( $wp_customize )
{
    $wp_customize->get_section( 'colors' )->title = esc_html__( "Color Options", 'dalmatian-blog' );
