 ...
 */
 ...
 ( function( $ ) {
	...
	wp.customize( 'nav_border_color', function( value ) {
		value.bind( function( to ) {
			$( '..primary-menu ul li ul.sub-menu li:last-of-type, .primary-menu ul li ul.sub-menu li, ul.sub-menu, .primary-menu, .super-menu' ).css( {
				'border-color':to
			});
		} );
	} );

	wp.customize( 'sidebar_headline_border_bottom_color', function( value ) {
		value.bind( function( to ) {
			$( '.swidgets-wrap .sidebar-title-border' ).css( {
