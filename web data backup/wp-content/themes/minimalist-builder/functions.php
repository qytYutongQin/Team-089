...
add_action( 'wp_enqueue_scripts', 'minimalist_builder_google_fonts' );
	...
	add_action( 'tgmpa_register', 'minimalist_builder_register_required_plugins' );

	function minimalist_builder_register_required_plugins() {
		$plugins = array(
			array(
		...
		$config = array(
			'id'           => 'minimalist-builder',                 // Unique ID for hashing notices for multiple instances of TGMPA.
