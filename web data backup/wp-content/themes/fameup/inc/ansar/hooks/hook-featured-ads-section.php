<?php if (!function_exists('fameup_featured_ads_section')) :
/**
 *  Header
 *
 * @since Fameup
 *
 */
function fameup_featured_ads_section()
{
...
?>
          ...
          <div class="col-md-4">
                <div class="bs-widget promo bshre" style="background-image: url('<?php echo esc_url($fatured_post_image_one); ?>');">
                  ...
                  <div class="inner-content">
                    <div class="text">
                      <?php if($featured_post_one_btn_txt) {?>
          ...
          <div class="col-md-4">
                <div class="bs-widget promo bshre" style="background-image: url('<?php echo esc_url($fatured_post_image_two); ?>');">
                  ...
                  <div class="inner-content">
                    <div class="text">
                      <?php if($featured_post_two_btn_txt) { ?>
          ...
          <div class="col-md-4">
                <div class="bs-widget promo bshre" style="background-image: url('<?php echo esc_url($fatured_post_image_three); ?>');">
                  ...
                  <div class="inner-content">
                    <div class="text">
                      <?php if($featured_post_three_btn_txt) {?>
...
add_action('fameup_action_featured_ads_section', 'fameup_featured_ads_section', 5);