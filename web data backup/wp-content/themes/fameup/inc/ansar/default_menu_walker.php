<?php 
function fameup_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'fameup_page_menu_args' );
function fameup_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new fameup_walker_page_menu;
...
class fameup_walker_page_menu extends Walker_Page{
