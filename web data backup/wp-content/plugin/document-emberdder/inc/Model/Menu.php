...
class Menu{
    ...
    function ppv_submenu_page_callback() {
       ...
       <div class="wrap"><div id="icon-tools" class="icon32"></div>
            <h2><?php echo esc_html__('Developer', 'ppv') ?></h2>
            <h2>Md Abu hayat polash</h2>
            <h4><?php echo esc_html__('Professional Web Developer (Freelancer)', 'ppv') ?></h4>
            <h5><?php echo esc_html__('Web', 'ppv') ?> : <a href="http://abuhayatpolash.com">www.abuhayatpolash.com</h5></a>
            <h5> : <a target="_blank" href="https://www.upwork.com/freelancers/~01c73e1e24504a195e">On Upwork.com</h5>
    ...
    function ppv_howto_page_callback() {
        ?>
       <div class='wrap'><div id='icon-tools' class='icon32'></div>
           <h2><?php echo esc_html__('How to use ?', 'ppv') ?> </h2>
            <h2><?php echo esc_html__('We made a movie for you ! Watch it and learn.', 'ppv') ?> </h2>
            <br/>
